...
const PortfolioTemplate = () => {
  return (
    <Layout>
      {/* Intoduction */}
      <p tw="lg:text-6xl md:text-5xl text-4xl text-tertiay lg:px-40 md:px-24 px-4 lg:leading-relaxed md:leading-relaxed sm:leading-relaxed md:py-24 py-14">
        I&apos;m a Front-end Developer who is interested in the reusable
        components of React.
      </p>

      {/* Section1 */}
      <div tw="bg-primary lg:px-40 md:px-24 px-4 md:py-12 py-8 text-tertiay">
        <Section
      ...
      {/* Section3 */}
      <div tw="bg-[#F9F3E4] lg:px-40 md:px-24 px-4 md:py-12 py-8">
        <Section
