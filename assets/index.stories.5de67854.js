var d=Object.defineProperty;var r=(t,e)=>d(t,"name",{value:e,configurable:!0});import{r as a,j as i}from"./jsx-runtime.5e187358.js";import{B as P}from"./index.5aef70f4.js";import"./iframe.6b1784ba.js";import"./styled-components.browser.esm.b36e809d.js";import"./index.10b0fe92.js";import"./index.fb05a858.js";import"./clsx.m.256e9345.js";import"./index.6dcff9be.js";import"./index.a935901e.js";import"./index.58c2d415.js";import"./index.55e00f07.js";const u=r(()=>{const[t,e]=a.exports.useState([]);return a.exports.useEffect(()=>{fetch("https://api.rss2json.com/v1/api.json?rss_url=https%3A%2F%2Fquessr.tistory.com%2Frss&api_key=4yj4wfdfz8oekzauivyrznnwjjrdtp032aowo1jm").then(o=>o.json()).then(o=>o.items).then(o=>{const c=new DOMParser,l=o.map(s=>{var n,p;const g=(p=(n=c.parseFromString(s.description,"text/html").querySelector("body"))==null?void 0:n.textContent)!=null?p:"";return{...s,description:g}});e(l)})}),i(P,{items:t})},"BlogPage"),m=u,S={parameters:{storySource:{source:`import { ComponentMeta } from '@storybook/react';
import 'twin.macro';
...
//# sourceMappingURL=index.stories.5de67854.js.map
