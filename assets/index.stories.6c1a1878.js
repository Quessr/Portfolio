var d=Object.defineProperty;var r=(t,e)=>d(t,"name",{value:e,configurable:!0});import{r as a,j as i}from"./jsx-runtime.fee01133.js";import{B as P}from"./index.bc0c32eb.js";import"./iframe.ba1442a9.js";import"./styled-components.browser.esm.517e8535.js";import"./index.814582ec.js";import"./index.aaa347a7.js";import"./clsx.m.256e9345.js";import"./index.b01d1e67.js";import"./index.be564635.js";import"./index.319da86e.js";import"./index.c8c6c660.js";const u=r(()=>{const[t,e]=a.exports.useState([]);return a.exports.useEffect(()=>{fetch("https://api.rss2json.com/v1/api.json?rss_url=https%3A%2F%2Fquessr.tistory.com%2Frss&api_key=4yj4wfdfz8oekzauivyrznnwjjrdtp032aowo1jm").then(o=>o.json()).then(o=>o.items).then(o=>{const c=new DOMParser,l=o.map(s=>{var n,p;const g=(p=(n=c.parseFromString(s.description,"text/html").querySelector("body"))==null?void 0:n.textContent)!=null?p:"";return{...s,description:g}});e(l)})}),i(P,{items:t})},"BlogPage"),m=u,S={parameters:{storySource:{source:`import { ComponentMeta } from '@storybook/react';
import 'twin.macro';
...
//# sourceMappingURL=index.stories.6c1a1878.js.map
