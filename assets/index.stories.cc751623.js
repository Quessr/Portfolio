var d=Object.defineProperty;var r=(t,e)=>d(t,"name",{value:e,configurable:!0});import{r as a,j as i}from"./jsx-runtime.45e6a16a.js";import{B as P}from"./index.392ab1a4.js";import"./iframe.d87281ea.js";import"./styled-components.browser.esm.8c7d581b.js";import"./index.36f53425.js";import"./index.28c0af58.js";import"./clsx.m.256e9345.js";import"./index.c11e48c5.js";import"./index.79aa33b3.js";import"./index.43f1eb23.js";import"./index.4134a7e1.js";const u=r(()=>{const[t,e]=a.exports.useState([]);return a.exports.useEffect(()=>{fetch("https://api.rss2json.com/v1/api.json?rss_url=https%3A%2F%2Fquessr.tistory.com%2Frss&api_key=4yj4wfdfz8oekzauivyrznnwjjrdtp032aowo1jm").then(o=>o.json()).then(o=>o.items).then(o=>{const c=new DOMParser,l=o.map(s=>{var n,p;const g=(p=(n=c.parseFromString(s.description,"text/html").querySelector("body"))==null?void 0:n.textContent)!=null?p:"";return{...s,description:g}});e(l)})}),i(P,{items:t})},"BlogPage"),m=u,S={parameters:{storySource:{source:`import { ComponentMeta } from '@storybook/react';
import 'twin.macro';
...
//# sourceMappingURL=index.stories.cc751623.js.map
